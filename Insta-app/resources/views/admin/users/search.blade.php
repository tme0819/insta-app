...
@section('title', 'Admin: Explore People')

@section('content')
<ul class="navbar-nav ms-auto mb-3">
    <form action="{{ route('admin.search') }}" style="width: 300px">
        <input type="search" name="search" id="search" placeholder="Search..." class="form-control form-control-sm" value="{{ old('search', $search)}}">
    </form>
</ul>
<table class="table table-hover align-middle bg-white border text-secondary">
    ...
    <tbody>
        ...
        @empty
            <div class="text-muted h5 text-center mb-3">No Result Found</div>
        @endforelse
    </tbody>
</table>
@endsection